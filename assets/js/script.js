...
//delegated `span` click using `.list-group`
...
$(".list-group").on("change", "input[type='text']", function(){
  ...
  // update task in array and resave in localstorage
...
// makes the lists sortable across lists and within themselves
...
// save button in modal event listener 
...
// set interval to audit due date
